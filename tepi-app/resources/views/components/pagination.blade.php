...
@if ($lastpage > 1)
    ...
    <nav aria-label="Page navigation example">
        <ul class="flex items-center -space-x-px h-10 text-base">
            ...
            <li>
                <a href="{{ $currentpage - 1 > 0 ? '?page=' . $currentpage - 1 . '&search=' . $search['search'] . '&status=' . $search['state'] : '' }}"
            ...
            <li>
                <a href="{{ $currentpage + 1 <= $lastpage ? '?page=' . $currentpage + 1 . '&search=' . $search['search'] . '&status=' . $search['state'] : '' }}"
